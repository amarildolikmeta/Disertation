...
\begin{figure}
 \centering \includegraphics[width=0.7\linewidth]{breakout_frame.jpeg}
 \caption{Frame taken from the Breakout Atari 2600 game.}
 \label{fig:breakout_frame}
\end{figure}
\begin{figure}
 \centering \includegraphics[width=\linewidth]{Breakout/learning_curve.pdf}
...
\begin{figure}[H]
 \centering \includegraphics[width=0.7\linewidth]{montezuma_revenge_frame.jpg}
...
\begin{figure}[H]
 \centering \includegraphics[width=\linewidth]{Montezuma/learning_curve.pdf}
